...
if __name__ == '__main__':
    ...
    parser.add_argument("-test", "--testfile", type=str, help="Test corpus in the same format as training file")
    parser.add_argument("-kbest", "--kbestfile", type=str, help="kBest corpus with second files as text")
    parser.add_argument("-f", "--freqcutoff", type=int, default=10, help="Frequency cutoff")
    ...
    parser.add_argument("-n", "--numepoch", type=int, default=20, help="No. of epochs")
    parser.add_argument("-b", "--batchsize", type=int, default=50, help="Batch size")
    parser.add_argument("-o", "--outputfile", type=str, default='output', help="Output File Name")
    parser.add_argument("-hid", "--hiddenlayer", type=int, default=500, help="No. of nodes in hidden layers")
    parser.add_argument("-r", "--learningrate", type=float, default=0.05, help="Learning rate for backprop")
    ...
    datasets, lang1Vocab, lang2Vocab = get_datasets(trainFileName, valFileName, testFileName, kbestFileName, freqCutoff)
    ...
    with open(outFileName+'_vocab', 'w') as vocabFile:
        vocabFile.write(json.dumps(lang1Vocab).encode('utf-8')+'\n')
        vocabFile.write(json.dumps(lang2Vocab).encode('utf-8'))
